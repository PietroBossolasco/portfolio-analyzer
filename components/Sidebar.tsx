...
const SECTIONS: { label: string; links: { href: string; label: string; icon: (p: IconProps) => JSX.Element }[] }[] = [
  {
    label: "Portafoglio",
    links: [
...
export default function Sidebar({
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-ink-gradient text-slate-300">
      {/* Brand */}
